# doc strings are place as the first line inside the class
# you can access it using __doc__ method.
# ex - print(movie1.__doc__)
# Note that doc strings are not inherited by child classes
